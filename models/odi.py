...
Original file is located at
    https://colab.research.google.com/drive/1aVmEPYjiyv9fRH6JkOA-ci0LdOXnzxCH
"""
...
def team_recom(pl_list):
    ...
    for x in pl_list:
        ...
        elif ((new_pls[3] not in opp_list) and (new_pls[3] not in pl_list)):
            opp_list.append(new_pls[3])
        else:
            opp_list.append(new_pls[4])
